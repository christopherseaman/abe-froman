...
| Direct Anthropic API backend | Execution engines → Backends to add | Landed | Becomes primary Samus backend (mitigates ACP process-tree leaks). The Samus-priority sub-bullet "direct Claude API token tracking" is **out of scope** on sqrlly (decided 2026-05-06) — not a requirement |
