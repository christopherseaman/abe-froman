...
EXPECTED = [
    ...
    "sqrlly/_examples/absurd-paper/subgraphs/single_review.yaml",
    "sqrlly/_examples/absurd-paper/prompts/abstract.md",
    "sqrlly/_examples/absurd-paper/prompts/choose_topic.md",
    "sqrlly/_examples/absurd-paper/prompts/critique_review.md",
    ...
    "sqrlly/_examples/absurd-paper/prompts/publish_verdict.md",
    "sqrlly/_examples/absurd-paper/prompts/reconcile.md",
    "sqrlly/_examples/absurd-paper/prompts/results.md",
    "sqrlly/_examples/absurd-paper/prompts/reviewer_pool.md",
    "sqrlly/_examples/absurd-paper/prompts/reviewer_review.md",
    ...
    "sqrlly/_examples/absurd-paper/gates/publish_verdict.md",
    "sqrlly/_examples/absurd-paper/gates/review_quality.py",
